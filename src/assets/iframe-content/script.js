...
let forMenuTranslation = document.getElementById("menu");
if (location.search.split("=")[1] === "de") {
  forMenuTranslation.children[1].textContent = "Standard Bild";
  forMenuTranslation.children[2].textContent = "Bild laden";
  forMenuTranslation.children[3].children[0].textContent = "Form";
  forMenuTranslation.children[3].children[1].children[0].textContent =
    "klassisch";
  forMenuTranslation.children[3].children[1].children[1].textContent =
    "dreieckig";
  forMenuTranslation.children[3].children[1].children[2].textContent = "rund";
  forMenuTranslation.children[3].children[1].children[3].textContent = "gerade";
  forMenuTranslation.children[4].textContent = "12 Teile";
  forMenuTranslation.children[5].textContent = "25 Teile";
  forMenuTranslation.children[6].textContent = "50 Teile";
  forMenuTranslation.children[7].textContent = "100 Teile";
  forMenuTranslation.children[8].textContent = "200 Teile";
}
